...
export default class E_Minus extends E_Base {
  @Column({
    type: 'integer',
    name: 'account_id',
  })
  ...
  amount: number;
  // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  @ManyToOne(() => E_Account, account => account.minuses)
  @JoinColumn({
    name: 'account_id',
  ...
  @ManyToOne(() => E_Wallet, wallet => wallet.minuses)
  @JoinColumn({
    name: 'wallet_id',
    referencedColumnName: 'id'
  })
  ...
  @ManyToOne(() => E_Currency, currency => currency.minuses)
  @JoinColumn({
    name: 'currency_id',
    referencedColumnName: 'id'
  })
  ...
  @ManyToOne(() => E_Category, category => category.minuses)
  @JoinColumn({
    name: 'category_id',
    referencedColumnName: 'id'
  })
  ...
  @ManyToOne(() => E_Group, group => group.minuses)
  @JoinColumn({
    name: 'group_id',
    referencedColumnName: 'id'
  })
